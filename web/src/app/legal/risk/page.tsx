    ...
    <LegalPage
      ...
      sections={[
        ...
        },
        {
          ...
          body: [
            "Trackers built on regulatory filings inherit the filing's delay. A 13F can be up to 45 days old, so the basket describes a portfolio the manager may have already exited.",
